...
* Application Context: advance container which provide more functionalities than bean Factory. ApplicationContext **context**=**new** ClassPathXmlApplicationContext("bean.xml");
